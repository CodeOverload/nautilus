...
nautilus_files_view_init (NautilusFilesView *view)
{
        ...
        view->details->toolbar_menu_sections->show_undo = TRUE;
        view->details->toolbar_menu_sections->zoom = g_object_ref_sink (gtk_builder_get_object (builder, "zoom_section"));
        view->details->toolbar_menu_sections->custom = g_object_ref_sink (gtk_builder_get_object (builder, "view_custom_section"));
