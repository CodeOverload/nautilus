                                       ...
                                       NautilusWindowSlot *slot)
{
        ...
        if (new_sections->zoom != NULL)
                gtk_box_pack_start (GTK_BOX (toolbar->priv->view_menu_zoom_section), new_sections->zoom, FALSE, FALSE, 0);

        if (new_sections->custom != NULL)
                gtk_box_pack_start (GTK_BOX (toolbar->priv->view_menu_custom_section), new_sections->custom, FALSE, FALSE, 0);
}
